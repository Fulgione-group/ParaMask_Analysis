...
for(k in reps){
  print(k)
  Sim<-read.table(file = paste("Sim_final/HW_10PercentParalogs/ParaMask_runs/Sim0.1HW_rep",as.character(k),"EMresults.finalClass.het", sep = ""), header = T, sep = "\t")
  SVtab<- read.table(file = paste("Sim_final/HW_10PercentParalogs/SVtab_0.1_rep",as.character(k) ,".txt", sep=""), header = T, sep = "\t")
  SVtab$cluster <- 0
  ...
  SVtab_infer<-read.table(file = paste("Sim_final/HW_10PercentParalogs/ParaMask_runs/Sim0.1HW_rep",as.character(k),"EMresults.finalClass.bed", sep = ""), header = T, sep = "\t")
...
for(k in reps){
  print(k)
  Sim<-read.table(file = paste("Sim_final/HW_50PercentParalogs/ParaMask_runs/Sim0.5HW_rep",as.character(k),"EMresults.finalClass.het", sep = ""), header = T, sep = "\t")
  SVtab<- read.table(file = paste("Sim_final/HW_50PercentParalogs/SVtab_0.5_rep",as.character(k) ,".txt", sep=""), header = T, sep = "\t")
  ...
  SVtab_infer<-read.table(file = paste("Sim_final/HW_50PercentParalogs/ParaMask_runs/Sim0.5HW_rep",as.character(k),"EMresults.finalClass.bed", sep = ""), header = T, sep = "\t")
...
for(k in reps){
  print(k)
  Sim<-read.table(file = paste("Sim_final/Fis0.9_10PercentParalogs/ParaMask_runs/Sim0.1Fis0.9_rep",as.character(k),"EMresults.finalClass.het", sep = ""), header = T, sep = "\t")
  SVtab<- read.table(file = paste("Sim_final/Fis0.9_10PercentParalogs/SVtab_0.1_rep",as.character(k) ,".txt", sep=""), header = T, sep = "\t")
  SVtab$cluster <- 0
  SVtab$cluster[SVtab$type=="par"] <-1:length(SVtab$cluster[SVtab$type=="par"])
  ...
  SVtab_infer<-read.table(file = paste("Sim_final/Fis0.9_10PercentParalogs/ParaMask_runs/Sim0.1Fis0.9_rep",as.character(k),"EMresults.finalClass.bed", sep = ""), header = T, sep = "\t")
...
for(k in reps){
  print(k)
  Sim<-read.table(file = paste("Sim_final/Fis0.9_50PercentParalogs/ParaMask_runs/Sim0.5Fis0.9_rep",as.character(k),"EMresults.finalClass.het", sep = ""), header = T, sep = "\t")
  SVtab<- read.table(file = paste("Sim_final/Fis0.9_50PercentParalogs/SVtab_0.5_rep",as.character(k) ,".txt", sep=""), header = T, sep = "\t")
  SVtab$cluster <- 0
  SVtab$cluster[SVtab$type=="par"] <-1:length(SVtab$cluster[SVtab$type=="par"])
  ...
  SVtab_infer<-read.table(file = paste("Sim_final/Fis0.9_50PercentParalogs/ParaMask_runs/Sim0.5Fis0.9_rep",as.character(k),"EMresults.finalClass.bed", sep = ""), header = T, sep = "\t")
...
# write.table(x = result_tab,file = "/Sim_final/results_HW_Fis0.9_10P_50P.txt", col.names = T, quote = F, sep="\t")
# result_tab<- read.table(file = "/Sim_final/results_HW_Fis0.9_10P_50P.txt",header = T, sep = "\t")
...
# write.table(x = stab, file = "/Sim_final/stab.txt", sep="\t", col.names = T)
stab<- read.table("/Sim_final/stab.txt", header = T, sep = "\t")
