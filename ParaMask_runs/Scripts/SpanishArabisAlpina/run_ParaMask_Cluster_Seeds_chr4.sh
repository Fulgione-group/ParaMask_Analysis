...
java -jar ~/scripts/ParaMask_simulation_scripts/ParaMask_Cluster_Seeds.jar \
	--cov GATK4.2_1000Genomes_chrall.filteredQ30LD5UD100K.final.ES03ES04Paramask.10PerMissing.snps.b.vcf.finalParaMaskIn.het.cov.stat.chr4.txt \
	--het ES0304_run_finalEMresults.chr4.het \
	--cutoff 254 \
