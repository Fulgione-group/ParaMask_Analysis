...
##convert to vcf
#SC
bash run_genotypetype_to_mat_SC_withSelfing.sh REP_NUMBER PATH_TO_SEDUS_OUTPUT_DIR
#SV
bash run_genotypetype_to_mat_SV_new_withSelfing.sh REP_NUMBER PATH_TO_SEDUS_OUTPUT_DIR
